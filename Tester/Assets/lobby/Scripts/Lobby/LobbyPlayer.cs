...
namespace Prototype.NetworkLobby
{
    ...
    public class LobbyPlayer : NetworkLobbyPlayer
    {
        ...
        private void Start()
        {
            myplayermodelpreviewer = GameObject.FindGameObjectWithTag("isfirstplayer");
            Debug.Log(myplayermodelpreviewer);
            //myplayermodelpreviewer.SetActive(false);
        }
